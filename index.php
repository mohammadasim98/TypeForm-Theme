                ...
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-text">
                            <input type="text" class="form-element" name="q1" required>
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-text">
                            <input type="text" class="form-element" name="q2" required>
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        <label class='form-title' for="q3">Enter you age: </label>
                        <div class="form-input-radio">
                            ...
                            <input type="hidden" name="q3" class="hidden-radio" required>
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-radio">
                            ...
                            <input type="hidden" name="q4" class="hidden-radio">                        
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-radio">
                            ...
                            <input type="hidden" name="q5" class="hidden-radio">                        
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-radio">
                            ...
                            <input type="hidden" name="q6" class="hidden-radio">
                        </div>
                    </div>
                </div>
                <div class='form-item'>
                    <div class="form-content">
                        ...
                        <div class="form-input-radio">
                            ...
                            <input type="hidden" name="q7" class="hidden-radio">
                        </div>
                    </div>
                </div>
                <div class='form-item'>
